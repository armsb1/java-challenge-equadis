package javachallengeequadistransaction.transactionservice.exception;
...
public class DefaultExceptionHandler {
    ...
    public ResponseEntity<ApiError> handle(IllegalStateException e, HttpServletRequest request) {
        ApiError apiError = new ApiError(request.getRequestURI(),
                                         e.getMessage(),
    ...
    public ResponseEntity<ApiError> handle(InsufficientBalanceException e, HttpServletRequest request) {
        ApiError apiError = new ApiError(request.getRequestURI(),
                                         e.getMessage(),
